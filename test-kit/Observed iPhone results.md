...
User confirmed Google Calendar notifications arrived on both iPhone and PC, and events disappeared during previous deletion runs. Exact notification event/run attribution and PC client version were not recorded. These observations establish ordinary notification delivery and event disappearance, not stale DELETE protection, durable restart cancellation recovery or multi-device ordering.
